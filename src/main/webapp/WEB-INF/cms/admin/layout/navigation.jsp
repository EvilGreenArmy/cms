<%@ page contentType="text/html;charset=UTF-8" import="com.cms.entities.admin.SourceInfo"%>
...
<%--  <c:forEach var="parent" items="${parentList}">
  ...
  <dd>
    <div class="title">
      <span><img src="${basePath}/img/admin/login/leftico01.png" /></span>业务管理
      <div class="clear"></div>
    </div>

    <ul class="menuson">
          <li><cite></cite><a href="javascript:;" onclick="getData('${basePath}/news/list.do','','workspace');">内容发布</a><i></i></li>
    </ul>
  </dd>
</dl>
