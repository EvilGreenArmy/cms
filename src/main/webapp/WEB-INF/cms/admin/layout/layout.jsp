...
<head>
    ...
    <link href="${basePath}/js/admin/kindeditor/themes/default/default.css" rel="stylesheet" type="text/css" />
    ...
    <script type="text/javascript"
            src="${basePath}/js/admin/kindeditor/kindeditor-min.js"></script>
    <script type="text/javascript"
            src="${basePath}/js/admin/kindeditor/lang/zh_CN.js"></script>
    <script type="text/javascript">
        var editor;
